...
def run(page_link):
    ...
    for link in links:
        try:
            ...
            q1 = "insert into mobile(pid,p_name,MRP,SP,Rating,Image,Specification,product_link) values ('{}','{}','{}','{}','{}','{}','{}','{}')".format(doc['pid'], doc['name'] ,doc['mrp'],doc['selling_price'],doc['rating'],doc["image"],doc['specification'],doc['product_link'])
